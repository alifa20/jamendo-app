...
This project uses [pnpm](https://pnpm.io/) as the package manager for optimal performance and monorepo support.
...
You can check if your monorepo is installing multiple versions of React Native with the `pnpm why` command:
